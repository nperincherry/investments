...
#. We value options be creating a portfolio which replicates the option, and rely on arbitrage to ensure the prices of the replicating portfolio and the option are the same.
